...
public class Modificando_ejercicio extends JFrame {
	...
	public Modificando_ejercicio(Ejercicio ejer, int id_rutina, Usuario usser) {
		ejercicio = ejer;
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Mod_ejer frame = new Mod_ejer(id_rutina, usser);
