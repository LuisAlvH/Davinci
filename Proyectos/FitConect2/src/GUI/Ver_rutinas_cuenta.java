...
public class Ver_rutinas_cuenta extends JFrame {
	...
	public Ver_rutinas_cuenta(Usuario usser) {
		...
		lblNewLabel.setBounds(202, 24, 94, 28);
		...
		btnModEjer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					Mod_ejer frame = new Mod_ejer(idRutina, usser);
		...
		btnCompartir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					EntradaYsalida.actualizarRutnaAtributoCompartida(idRutina, 1);
		...
		btnModRut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					Modificando_rutis frame = new Modificando_rutis(idRutina, usser);
					frame.setVisible(true);
					dispose();
		...
		ArrayList<Integer> MisRutinas = EntradaYsalida.obteneniendoRutiSinCompa(usser.getIdUsuario());
